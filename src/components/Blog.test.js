...
beforeEach(() => {
  component = render(<Blog blog={blog} user={user} updateHandler={updateHandler} deleteHandler={deleteHandler}/>)
})
...
//   await user_.click(buttonView)

//   const buttonLike = screen.getByText('like')
//   const buttonLike = screen.getByTestId('like-button')
//   await user.click(buttonLike)
  //await waitFor(() => {
    // fireEvent.click(buttonLike)
    // console.log(buttonLike)
    // const likebut2 = screen.getByTestId('like-button')
    // console.log(likebut2)
//})
//   const testComp = screen.getByTestId('author')
//   const testComponentText = testComp.textContent
//   console.log(testComponentText)

//   const likeComp = screen.getByTestId('like-block')
//   const likeComponentText = likeComp.textContent
//   console.log(likeComponentText)

  //await user.click(buttonLike)
//   console.log(updateHandler.mock)
